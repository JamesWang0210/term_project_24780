...
void player::turn(int &punchPos)
{

	SC.X_RightHandJoint_length = 20 - punchPos;
	SC.Y_RightHandJoint_length = 15 + punchPos;
	SC.X_LeftHandJoint_length2 = 40 + punchPos;
	SC.Y_LeftHandJoint_length2 = 30 - punchPos;

	punchPos += 3;
}

//void player::sit()   //there should be joints on the legs;
//{
//	int i;
//}